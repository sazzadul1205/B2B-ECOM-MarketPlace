      ...
      <div className="max-w-3xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">ব্যবহারকারী সম্পাদনা</h1>
              <p className="text-sm text-gray-600 mt-1">
                ব্যবহারকারীর তথ্য আপডেট করুন: {user.name}
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 space-y-6">
              ...
              <div className="border-t pt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">পাসওয়ার্ড পরিবর্তন (ঐচ্ছিক)</h3>
                <p className="text-sm text-gray-500 mb-4">বর্তমান পাসওয়ার্ড রাখতে ফাঁকা রাখুন</p>
                <div className="space-y-4">
                  {/* Password Field */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
              ...
              >
                {processing ? 'আপডেট হচ্ছে...' : 'ব্যবহারকারী আপডেট'}
              </button>
            </div>
          </form>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div className="text-sm text-yellow-700">
              <p className="font-medium mb-1">ব্যবহারকারীর ভূমিকা পরিবর্তন:</p>
              <p>যদি আপনি ব্যবহারকারীর ভূমিকা সাপ্লায়ার থেকে/এ পরিবর্তন করেন, তাহলে তাদের সাপ্লায়ার প্রোফাইল accordingly প্রভাবিত হবে।</p>
            </div>
          </div>
        </div>
      </div>
